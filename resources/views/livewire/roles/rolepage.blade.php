                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-danger btn-sm float-end"
                                    wire:click.prevent="deleteConfirm({{ $role->id }})">Delete
                                    Role</button>
                                <button class="btn btn-warning btn-sm float-end" style="margin-right: 10px !important"
                                    data-coreui-toggle="modal" wire:click.prevent="edit({{ $role->id }})">Edit
                                    Role</button>
                            </td>
                        </tr>
                    @empty
